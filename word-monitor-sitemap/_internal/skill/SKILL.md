...
version: 0.3.2
description: "抓取多站 sitemap（含 onlinegames/playhop/suikagame/crazygames/coolmathgames/poki），按站点归档快照并输出新增内页、关键词候选，仅生成单一合并报告。"
---
...
- `sitemapindex` 嵌套递归跟随，受 `maxSitemapsPerSite` 总量上限保护
